...
if __name__ == '__main__':
    print(recognize_url('https://www.douban.com/misc/captcha?id=lgivVWOcapmPpI3QFeHOhIWr:en'))
    print(recognize_url('https://www.douban.com/misc/captcha?id=oaKc8KWD8LhJQyJS84LJp2oe:en'))
